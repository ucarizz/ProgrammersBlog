...
`
            ...
            $.ajax({
                ...
                success: function (data) {
                    ...
                    if (isValid) {
                        ...
                        toastr.success('test', 'Başarılı işlem');
                    } else {
                        let summaryText = "";
    ...
    $(document).on('click', '.btn-delete', function (event) {
        ...
        Swal.fire({
            ...
            text: `${userName} Seçili kategori silinecektir!`,
            icon: 'warning',
    ...
    <tr name="${categoryUpdateAjaxModel.CategoryDto.Category.Id}">
        ...
        <td>
             ...
             <button class="btn btn-danger btn-sm btn-block btn-delete" data-id="${categoryUpdateAjaxModel.CategoryDto.Category.Id}"><span class="fas fa-minus-circle"></span></button>
                    ...
                    toastr.success(`${userAddAjaxModel.CategoryDto.Message}`, 'Başarılı güncelleme işlemi');
                } else {
                    let summaryText = "";
                    $('#validation-summary > ul > li').each(function () {
                        let text = $(this).text;
