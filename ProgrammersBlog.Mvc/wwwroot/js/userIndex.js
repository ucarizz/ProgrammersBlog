...
$(document).ready(function () {
        ...
        buttons: [
            ...
            },
            {
                ...
                action: function (e, dt, node, config) {
                    $.ajax({
                        type: 'GET',
                        url: '/Admin/UserController/GetAllCategories/',
    ...
    $(document).on('click', '.btn-delete', function (event) {
        ...
        Swal.fire({
            ...
            text: `${categoryName} Seçili kategori silinecektir!`,
            icon: 'warning',
    ...
    $(function () {
        ...
        $(document).on('click', '.btn-update',
            function (event) {
                ...
                event.preventDefault();
                const id = $(this).attr('data-id');
                console.log($.get(url, { categoryId: id }));
    ...
    <tr name="${categoryUpdateAjaxModel.CategoryDto.Category.Id}">
        ...
        <td>
             ...
             <button class="btn btn-danger btn-sm btn-block btn-delete" data-id="${categoryUpdateAjaxModel.CategoryDto.Category.Id}"><span class="fas fa-minus-circle"></span></button>
                    ...
                    toastr.success(`${categoryAddAjaxModel.CategoryDto.Message}`, 'Başarılı güncelleme işlemi');
                } else {
                    let summaryText = "";
                    $('#validation-summary > ul > li').each(function () {
                        let text = $(this).text;
